    ...
    <div className="min-h-screen bg-[#f5f5f5] pt-20 sm:pt-24 md:pt-28">
      <div className="p-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-black text-[#2a2a2a] mb-6">About Us</h1>
          <div className="space-y-4 text-[#2a2a2a]">
            <p className="text-lg leading-relaxed">
              Welcome to our company. We are dedicated to helping you find your dream home with elegance and style.
            </p>
            <p className="text-lg leading-relaxed">
